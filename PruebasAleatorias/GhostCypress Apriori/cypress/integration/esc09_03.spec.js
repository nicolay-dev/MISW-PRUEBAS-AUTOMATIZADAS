...
describe('Create and edit page', () => {
    ...
    it('Login to ghost, create page, publish page, edit title of page, validate  page edited with seed', function(){  
        ...
        POM.publishUpdatePP()
         ...
         cy.wait(1000)
            ...
            cy.get("h3").then(($title) => {
                expect($title[0].innerText).to.equal(`${this.data.seudo[0].title}`+`${this.data.seudo[0].titleEdit}`)
