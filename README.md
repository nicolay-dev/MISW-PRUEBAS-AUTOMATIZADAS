# MISW-PRUEBAS-AUTOMATIZADAS
  ...
  Para mayor detalle de la estrategia de pruebas se puede consultar el documento ["Estrategia de Prueba.pdf"](./EstrategiaPruebas(Semana8)/Estrategia_de_Prueba.pdf)  
